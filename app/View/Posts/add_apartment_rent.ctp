...
//        'style' => 'display:none'
        ...
        <?php
        echo $this->Form->input('Post.baseRent', array(
        ...
        echo $this->Form->input('Apartmentrent.serviceCharge', array(
        ...
        echo $this->Form->input('Apartmentrent.totalRent', array(
        ...
        echo $this->Form->input('Apartmentrent.deposit', array(
            'placeholder' => 'Kaution',
            'label' => array(
                'text' => 'Kaution',
            ),
            'beforeInput' => '<div class="input-group"><span class="input-group-addon">€</span>',
            'afterInput' => '</div>'
        ));  echo $this->Form->input('Apartmentrent.heatingCosts', array(
        ...
        echo $this->Form->input('Apartmentrent.heatingcostsInServiceCharge', array(
            'type' =>'checkbox',
...
//        ));
        ...
        echo $this->Form->input('Apartmentrent.apartmentType', array(
            'empty' => '(auswählen)',
            'label' => 'Wohnungstyp',
            'options' => array(
        ...
        echo $this->Form->input('Apartmentrent.floor', array(
            'label' => 'Etage',
            'placeholder' => 'Etage'
        ));
        echo $this->Form->input('Apartmentrent.numberOfFloors', array(
            'label' => 'Etagenzahl',
        ...
        echo $this->Form->input('Apartmentrent.usableFloorSpace', array(
            'label' => 'Nutzfläche',
        ...
        echo $this->Form->input('Apartmentrent.numberOfBedRooms', array(
            'label' => 'Anzahl Schlafzimmer',
            'placeholder' => 'Anzahl Schlafzimmer',
        ));

        echo $this->Form->input('Apartmentrent.numberOfBathRooms', array(
            'label' => 'Anzahl Badezimmer',
            'placeholder' => 'Anzahl Badezimmer',
        ));

        echo $this->Form->input('Apartmentrent.numberOfParkingSpaces', array(
            'label' => array(
        ...
        echo $this->Form->input('Apartmentrent.parkingSpaceType', array(
            'empty' => '(auswählen)',
            'label' => 'Parkplatz',
            'options' => array(
                'NO_INFORMATION ' => 'keine Angabe',
        ...
        echo $this->Form->input('Apartmentrent.parkingSpacePrice', array(
        ...
        echo $this->Form->input('Apartmentrent.condition', array(
            'empty' => '(auswählen)',
            'label' => 'Objektzustand',
        ...
        echo $this->Form->input('Apartmentrent.lastRefurbishment', array(
            'label' => array(
        ...
        echo $this->Form->input('Apartmentrent.interiorQuality', array(
            'empty' => '(auswählen)',
        ...
        ?>
        <?php echo $this->Form->input('Apartmentrent.constructionYear', array(
            'label' => array(
                'text' => 'Baujahr'
            ),
            'placeholder' => 'Baujahr'
        ...
        ?>
        <?php echo $this->Form->input('Apartmentrent.freeFrom', array('label' => 'Frei Ab',
            'dateFormat' => 'DMY',
            'minYear' => date('Y') - 0,
            'maxYear' => date('Y') - 0)); ?>
        <?php
        echo $this->Form->input('Apartmentrent.guestToilet', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        echo $this->Form->input('Apartmentrent.petsAllowed', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        echo $this->Form->input('Apartmentrent.lift', array(
            'type' => 'checkbox',
...
//        echo $this->Form->input('Apartmentrent.assistedLiving', array(
//            'type' => 'checkbox',
...
////            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
//        ));
        echo $this->Form->input('Apartmentrent.cellar', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        echo $this->Form->input('Apartmentrent.handicappedAccessible', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        echo $this->Form->input('Apartmentrent.builtInKitchen', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        echo $this->Form->input('Apartmentrent.balcony', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        echo $this->Form->input('Apartmentrent.certificateOfEligibilityNeeded', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        echo $this->Form->input('Apartmentrent.garden', array(
            'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
        ...
        <div class="col-lg-6" >
            ...
            echo $this->Form->input('Apartmentrent.energyPerformanceCertificate', array(
                'type' => 'checkbox',
...
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
            ...
            echo $this->Form->input('Apartmentrent.heatingType', array(
                'empty' => '(auswählen)',
                'label' => 'Heizungsart',
                'options' => array(
                    'NO_INFORMATION ' => 'keine Angabe',
            ...
            echo $this->Form->input('Apartmentrent.firingTypes', array(
                'empty' => '(auswählen)',
                ...
                'options' => array(
                    ...
                    'COAL' => 'Kohle')));
            ?>
<!--            --><?php //echo $this->Form->input('Apartmentrent.heatingTypeEnev2014', array(
...
//            )); ?>
            <?php
            echo $this->Form->input('Apartmentrent.BuildingEnergyRatingType', array(
                'empty' => '(auswählen)',
            ...
            echo $this->Form->input('Apartmentrent.thermalCharacteristic', array(
                'label' => 'Energieverbrauchskennwert',
                'placeholder' => 'Energieverbrauchskennwert',
            ));

            echo $this->Form->input('Apartmentrent.energyConsumptionContainsWarmWater', array(
                'type' => 'checkbox',
