...
<?php else: ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <!--        <img src="../server/php/files/' . $post['Garagerent']['id'] .'/'. $post['File'][0]['name']">-->
            <?php echo $this->Html->image('../server/php/files/' . $post['id'] .'/'. $post['File'][0]['name'], array('style' => 'width:100%')); ?>
        </div>
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <?php if (empty($post['Housebuy']['apartmentType'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Wohnungskategorie</strong>
                            <span class="pull-right">
                                               <?php echo($post['Housebuy']['apartmentType']); ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Housebuy']['serviceCharge'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Nebenkosten</strong>
                          <span class="pull-right">
 <?php
 $valu = $post['Housebuy']['serviceCharge'];
 echo $this->Number->currency($valu, "EUR");  ?>
            </li>
        <?php endif; ?>

        <?php if (empty($post['Housebuy']['heatingCosts'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Heizkosten</strong>
                          <span class="pull-right">
 <?php
 $valu = $post['Housebuy']['heatingCosts'];
 echo $this->Number->currency($valu, "EUR");  ?>
        ...
        <?php if (empty($post['Housebuy']['totalRent'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Gesamt miete</strong>
                          <span class="pull-right">
 <?php
 $valu = $post['Housebuy']['totalRent'];
 echo $this->Number->currency($valu, "EUR");  ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Housebuy']['deposit'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Kaution</strong>
                          <span class="pull-right">
<?php
$valu = $post['Housebuy']['deposit'];
echo $this->Number->currency($valu, "EUR");  ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Housebuy']['heatingcostsInServiceCharge'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Heizkosten sind in Nebenkosten enthalten.</strong>
                          <span class="pull-right">
                            <span class="glyphicon glyphicon-ok"></span>
<!--                              --><?php //echo($post['Housebuy']['heatingcostsInServiceCharge']); ?>
                            </span>
            </li>
        <?php endif; ?>


        <?php if (empty($post['Housebuy']['parkingSpacePrice'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Stellplatz Miete</strong>
                          <span class="pull-right">
                            <span class="glyphicon glyphicon-euro"></span>
                              <?php echo($post['Housebuy']['parkingSpacePrice']); ?>
                            </span>
            </li>
        <?php endif; ?>
        <!--        </div>-->
...
<div class="col-md-9">
    ...
    <?php if (empty($post['Housebuy']['floor'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Etage</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['floor']); ?>
                            </span>
    ...
    <?php if (empty($post['Housebuy']['numberOfParkingSpaces'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Parkflächenanzahl</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['numberOfParkingSpaces']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Housebuy']['condition'] )): ?>

    <?php else: ?>
        <li class="list-group-item">
            <strong>Objektzustand</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['condition']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Housebuy']['lastRefurbishment'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Letzte Modernisierung</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['lastRefurbishment']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Housebuy']['interiorQuality'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Qualität der Ausstattung</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['interiorQuality']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Housebuy']['constructionYear'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Baujahr</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['constructionYear']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Housebuy']['freeFrom'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Frei ab</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['freeFrom']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Housebuy']['heatingType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Heizungsart</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['heatingType']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Housebuy']['firingTypes'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Befeuerungsarten</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['firingTypes']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Housebuy']['BuildingEnergyRatingType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieausweistyp</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['BuildingEnergyRatingType']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Housebuy']['thermalCharacteristic'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieverbrauchskennwert</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['thermalCharacteristic']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Housebuy']['energyConsumptionContainsWarmWater'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieverbrauch enthält Warmwasser</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['energyConsumptionContainsWarmWater']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Housebuy']['numberOfFloors'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Etagenzahl</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['numberOfFloors']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Housebuy']['usableFloorSpace'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Nutzfläche</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['usableFloorSpace']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Housebuy']['numberOfBedRooms'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Anzahl Schlafzimmer</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['numberOfBedRooms']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Housebuy']['numberOfBathRooms'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Anzahl Badezimmer</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['numberOfBathRooms']); ?>
                            </span>
        </li>
    <?php endif; ?>
    <?php if (empty($post['Housebuy']['parkingSpaceType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Parkplatz</strong>
                            <span class="pull-right">
  <?php echo($post['Housebuy']['parkingSpaceType']); ?>
                            </span>
        </li>
    <?php endif; ?>
    <?php if (empty($post['Housebuy']['usableFloorSpace'] )): ?>
...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="col-md-6">
            ...
            <?php if (empty($post['Housebuy']['lift'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Housebuy']['cellar'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Housebuy']['handicappedAccessible'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Housebuy']['guestToilet'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Housebuy']['listed'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Housebuy']['summerResidencePractical'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Housebuy']['builtInKitchen'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Housebuy']['balcony'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Housebuy']['certificateOfEligibilityNeeded'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Housebuy']['garden'])): ?>
                <li class="list-group-item">
...
<div class="col-sm-5  col-md-4 ">
    ...
    <?php else: ?>
        <address>
            <legend>Objektadresse</legend>
            <!--                <strong>--><?php //echo $post['Housebuy']['street']; ?><!-- --><?php //echo $post['Housebuy']['houseNumber']; ?><!--</strong><br>-->
            <?php echo $post['Post']['postcode']; ?> <?php echo $post['Post']['city']; ?><br>
        </address>
