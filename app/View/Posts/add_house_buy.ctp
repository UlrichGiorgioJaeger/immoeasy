...
echo $this->Form->input('buildingType', array(
    'empty' => '(auswählen)',
    'label' => 'Hausstyp',
    'options' => array(
...
echo $this->Form->input('Housebuy.rented', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Housebuy.rentalIncome', array(
...
echo $this->Form->input('Housebuy.parkingSpacePrice', array(
...
echo $this->Form->input('Housebuy.price', array(
    'required' => true,
    'placeholder' => 'Kaufpreis.',
    'label' => array(
        'text' => 'Kaufpreis',
...
echo $this->Form->input('Housebuy.numberOfFloors', array(
    'label' => 'Etagenzahl',
...
echo $this->Form->input('Housebuy.usableFloorSpace', array(
    'label' => 'Nutzfläche',
...
echo $this->Form->input('Housebuy.numberOfBedRooms', array(
    'label' => 'Anzahl Schlafzimmer',
    'placeholder' => 'Anzahl Schlafzimmer',
));

echo $this->Form->input('Housebuy.numberOfBathRooms', array(
    'label' => 'Anzahl Badezimmer',
    'placeholder' => 'Anzahl Badezimmer',
));

echo $this->Form->input('Housebuy.numberOfParkingSpaces', array(
    'label' => array(
...
echo $this->Form->input('Housebuy.parkingSpaceType', array(
    'empty' => '(auswählen)',
    'label' => 'Parkplatz',
    'options' => array(
...
echo $this->Form->input('Housebuy.condition', array(
    'empty' => '(auswählen)',
    'label' => 'Objektzustand',
...
echo $this->Form->input('Housebuy.lastRefurbishment', array(
    'label' => array(
...
echo $this->Form->input('Housebuy.interiorQuality', array(
    'empty' => '(auswählen)',
...
?>
<?php echo $this->Form->input('Housebuy.constructionYear', array(
    'label' => array(
        'text' => 'Baujahr'
    ),
    'placeholder' => 'Baujahr'
...
<?php echo $this->Form->input('Housebuy.freeFrom', array('label' => 'Frei Ab',
    'dateFormat' => 'DMY',
    'minYear' => date('Y') - 0,
    'maxYear' => date('Y') - 0)); ?>
...
echo $this->Form->input('Housebuy.summerResidencePractical', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Housebuy.lodgerFlat', array(
    'type' => 'checkbox',
    'before' => '<label class="col col-md-3 control-label">Mit Einliegerwohnung</label>',
    'label' => false,
    'class' => false,
//            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
));
//echo $this->Form->input('Housebuy.petsAllowed', array(
//    'type' => 'checkbox',
...
////            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
//));
//echo $this->Form->input('Housebuy.lift', array(
//    'type' => 'checkbox',
...
////            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
//));
//echo $this->Form->input('Housebuy.assistedLiving', array(
//    'type' => 'checkbox',
...
////            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
//));
echo $this->Form->input('Housebuy.cellar', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Housebuy.guestToilet', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Housebuy.listed', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Housebuy.handicappedAccessible', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Housebuy.energyPerformanceCertificate', array(
    'type' => 'checkbox',
...
//echo $this->Form->input('Housebuy.builtInKitchen', array(
//    'type' => 'checkbox',
...
////            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
//));
//echo $this->Form->input('Housebuy.balcony', array(
//    'type' => 'checkbox',
...
////            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
//));
//echo $this->Form->input('Housebuy.certificateOfEligibilityNeeded', array(
//    'type' => 'checkbox',
...
////            'afterInput' => '<span class="help-block">Checkbox CakePHP Style</span>'
//));
//echo $this->Form->input('Housebuy.garden', array(
//    'type' => 'checkbox',
...
<div class="col-md-6" >
    ...
    <?php
    echo $this->Form->input('Housebuy.heatingType', array(
        'empty' => '(auswählen)',
        'label' => 'Heizungsart',
        'options' => array(
            'NO_INFORMATION' => 'keine Angabe',
    ...
    echo $this->Form->input('Housebuy.firingTypes', array(
        'empty' => '(auswählen)',
        ...
        'options' => array(
            ...
            'COAL' => 'Kohle')));
    ?>
<!--    --><?php //echo $this->Form->input('Housebuy.heatingTypeEnev2014', array(
...
//    )); ?>
    <?php
    echo $this->Form->input('Housebuy.buildingEnergyRatingType', array(
        'empty' => '(auswählen)',
    ...
    echo $this->Form->input('Housebuy.thermalCharacteristic', array(
        'label' => 'Energieverbrauchskennwert',
        'placeholder' => 'Energieverbrauchskennwert',
    ));

    echo $this->Form->input('Housebuy.energyConsumptionContainsWarmWater', array(
        'type' => 'checkbox',
