...
<!--        </div>-->
        <div class="col-md-6">
            ...
            <span>            <?php echo($post['Garagerent']['garageType']); ?>
</span>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <?php if (empty($post['Garagerent']['usableFloorSpace'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Nutzfläche</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['usableFloorSpace']); ?>
                            </span>
        ...
        <?php endif; ?>
            ...
            <?php if (empty($post['Garagerent']['freeFrom'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Frei ab</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['freeFrom']); ?>
                            </span>
                </li>
            <?php endif; ?>

            <?php if (empty($post['Garagerent']['freeUntil'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Frei ab</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['freeUntil']); ?>
                            </span>
                </li>
            <?php endif; ?>
            ...
            <?php if (empty($post['Garagerent']['condition'] )): ?>

        <?php else: ?>
            <li class="list-group-item">
                <strong>Objektzustand</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['condition']); ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Garagerent']['lastRefurbishment'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Letzte Modernisierung</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['lastRefurbishment']); ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Garagerent']['constructionYear'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Baujahr</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['constructionYear']); ?>
                            </span>
            </li>
        <?php endif; ?>
            ...
            <?php if (empty($post['Garagerent']['lengthGarage'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Länge Garage</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['lengthGarage']); ?>
                            </span>
            </li>
        <?php endif; ?>


        <?php if (empty($post['Garagerent']['widthGarage'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Weite Garage</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['widthGarage']); ?>
                            </span>
            </li>
        <?php endif; ?>

        <?php if (empty($post['Garagerent']['heightGarage'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Höhe der Garage</strong>
                            <span class="pull-right">
  <?php echo($post['Garagerent']['heightGarage']); ?>
                            </span>
            </li>
        <?php endif; ?>
...
<div class="col-sm-5  col-md-4 ">
    ...
    <?= $this->element('sidebar'); ?>
        ...
        <?php else: ?>
            <address>
                <legend>Objektadresse</legend>
                <!--                <strong>--><?php //echo $post['Post']['Garagerent']['street']; ?><!-- --><?php //echo $post['Post']['Garagerent']['houseNumber']; ?><!--</strong><br>-->
                <?php echo $post['Post']['postcode']; ?> <?php echo $post['Post']['city']; ?><br>
            </address>
