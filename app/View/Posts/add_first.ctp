...
<div class="well well-sm"><strong><i class="glyphicon glyphicon-ok form-control-feedback"></i> PflichtFeld</strong></br>
...
//            }
        ...
        $('#PostObjektartAnlage').click(function(){
            ...
            $('<option>').val("seniorCare").text("Altenpflegeeinrichtung").appendTo('#PostObjekttyp');



        });
               $( "#PostObjekttyp" ).change(function(){
                               $( "#apartment_rent" ).show();
...
<!--                 <div id="apartment_rent" style="display:none">-->
<!--        --><?php
