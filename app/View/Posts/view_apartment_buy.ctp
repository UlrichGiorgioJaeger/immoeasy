...
<?php if (empty($post['Apartmentbuy']['apartmentType'] )): ?>
<?php else: ?>
    <li class="list-group-item">
        <strong>Wohnungskategorie</strong>
                            <span class="pull-right">
                                               <?php echo($post['Apartmentbuy']['apartmentType']); ?>
                            </span>
    </li>
<?php endif; ?>
...
<?php if (empty($post['Apartmentbuy']['serviceCharge'] )): ?>
<?php else: ?>
    <li class="list-group-item">
        <strong>Wohngeld</strong>
                          <span class="pull-right">
 <?php
 $valu = $post['Apartmentbuy']['serviceCharge'];
 echo $this->Number->currency($valu, "EUR");  ?>
    </li>
<?php endif; ?>

<?php if (empty($post['Apartmentbuy']['parkingSpacePrice'] )): ?>
<?php else: ?>
    <li class="list-group-item">
        <strong>Stellplatz Kaufpreis</strong>
                          <span class="pull-right">
                            <span class="glyphicon glyphicon-euro"></span>
                              <?php echo($post['Apartmentbuy']['parkingSpacePrice']); ?>
                            </span>
    </li>
<?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['floor'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Etage</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['floor']); ?>
                            </span>
    ...
    <?php if (empty($post['Apartmentbuy']['numberOfParkingSpaces'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Parkflächenanzahl</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['numberOfParkingSpaces']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Apartmentbuy']['condition'] )): ?>

    <?php else: ?>
        <li class="list-group-item">
            <strong>Objektzustand</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['condition']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Apartmentbuy']['lastRefurbishment'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Letzte Modernisierung</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['lastRefurbishment']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentbuy']['interiorQuality'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Qualität der Ausstattung</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['interiorQuality']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentbuy']['constructionYear'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Baujahr</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['constructionYear']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Apartmentbuy']['freeFrom'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Frei ab</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['freeFrom']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['heatingType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Heizungsart</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['heatingType']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentbuy']['firingTypes'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Befeuerungsarten</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['firingTypes']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['BuildingEnergyRatingType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieausweistyp</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['BuildingEnergyRatingType']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['thermalCharacteristic'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieverbrauchskennwert</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['thermalCharacteristic']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['energyConsumptionContainsWarmWater'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieverbrauch enthält Warmwasser</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['energyConsumptionContainsWarmWater']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['numberOfFloors'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Etagenzahl</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['numberOfFloors']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Apartmentbuy']['usableFloorSpace'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Nutzfläche</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['usableFloorSpace']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['numberOfBedRooms'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Anzahl Schlafzimmer</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['numberOfBedRooms']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentbuy']['numberOfBathRooms'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Anzahl Badezimmer</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['numberOfBathRooms']); ?>
                            </span>
        </li>
    <?php endif; ?>
    <?php if (empty($post['Apartmentbuy']['parkingSpaceType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Parkplatz</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['parkingSpaceType']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentbuy']['rented'] )): ?>

    <?php else: ?>
        <li class="list-group-item">
            <strong>Vermietet</strong>
                          <span class="pull-right">
                            <span class="glyphicon glyphicon-ok"></span>
                            </span>
        </li>
        <?php if (empty($post['Apartmentbuy']['rentalIncome'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Mieteinnahmen pro Monat</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['rentalIncome']); ?>
                            </span>
            </li>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if (empty($post['Apartmentbuy']['marketingType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Vermarktungsart</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['marketingType']); ?>
                            </span>
        </li>
    <?php endif; ?>
    <?php if (empty($post['Apartmentbuy']['priceIntervalType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Zahlungsintervall</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentbuy']['priceIntervalType']); ?>
                            </span>
        </li>
    <?php endif; ?>
...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="col-md-6">
            ...
            <?php if (empty($post['Apartmentbuy']['lift'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentbuy']['cellar'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentbuy']['handicappedAccessible'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentbuy']['guestToilet'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Apartmentbuy']['listed'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Apartmentbuy']['summerResidencePractical'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Apartmentbuy']['builtInKitchen'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentbuy']['balcony'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentbuy']['certificateOfEligibilityNeeded'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentbuy']['garden'])): ?>
                <li class="list-group-item">
...
<div class="col-sm-5  col-md-4 ">
    ...
    <?= $this->element('sidebar'); ?>
        ...
        <?php else: ?>
            <address>
                <legend>Objektadresse</legend>
                <!--                <strong>--><?php //echo $post['Post']['Apartmentbuy']['street']; ?><!-- --><?php //echo $post['Post']['Apartmentbuy']['houseNumber']; ?><!--</strong><br>-->
                <?php echo $post['Post']['postcode']; ?> <?php echo $post['Post']['city']; ?><br>
            </address>
