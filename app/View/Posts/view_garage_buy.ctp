...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-gallery >
    ...
    <div class="carousel-inner" >
        <div class="item active">
            <?php
            echo $this->Html->image('carousel_2.jpg',array(alt=>'Immobilienbild'));
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="col-md-6">
            <strong>Garagen Typ</strong></br>
            <span><?php echo($post['Garagebuy']['garageType']); ?>
</span>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-9">
            ...
            <?php if (empty($post['Garagebuy']['usableFloorSpace'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Nutzfläche</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['usableFloorSpace']); ?>
                            </span>
            ...
            <?php if (empty($post['Garagebuy']['freeFrom'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Frei ab</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['freeFrom']); ?>
                            </span>
                </li>
            <?php endif; ?>

            <?php if (empty($post['Garagebuy']['freeUntil'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Frei ab</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['freeUntil']); ?>
                            </span>
                </li>
            <?php endif; ?>
            ...
            <?php if (empty($post['Garagebuy']['condition'] )): ?>

            <?php else: ?>
                <li class="list-group-item">
                    <strong>Objektzustand</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['condition']); ?>
                            </span>
                </li>
            <?php endif; ?>
            ...
            <?php if (empty($post['Garagebuy']['lastRefurbishment'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Letzte Modernisierung</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['lastRefurbishment']); ?>
                            </span>
                </li>
            <?php endif; ?>
            ...
            <?php if (empty($post['Garagebuy']['constructionYear'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Baujahr</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['constructionYear']); ?>
                            </span>
                </li>
            <?php endif; ?>
            ...
            <?php if (empty($post['Garagebuy']['lengthGarage'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Länge Garage</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['lengthGarage']); ?>
                            </span>
                </li>
            <?php endif; ?>


            <?php if (empty($post['Garagebuy']['widthGarage'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Breite Garage</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['widthGarage']); ?>
                            </span>
                </li>
            <?php endif; ?>

            <?php if (empty($post['Garagebuy']['heightGarage'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Höhe der Garage</strong>
                            <span class="pull-right">
  <?php echo($post['Garagebuy']['heightGarage']); ?>
                            </span>
                </li>
            <?php endif; ?>
