...
//        'style' => 'display:none'
        ...
        <?php
        echo $this->Form->input('storeType', array(
            'empty' => '(auswählen)',
            'label' => 'Ladentyp',
            'options' => array(
        ...
        <?php
        echo $this->Form->input('shopWindowLength', array(
            'label' => 'Schaufensterfront',
            'placeholder' => 'Schaufensterfront'

        ));
        echo $this->Form->input('goodsLiftLoad', array(
            'label' => 'Lastenaufzug Tragkraft',
            'placeholder' => 'Lastenaufzug Tragkraft'

        ));
        echo $this->Form->input('floorLoad', array(
            'label' => 'Deckenlast',
            'placeholder' => 'Deckenlast'
