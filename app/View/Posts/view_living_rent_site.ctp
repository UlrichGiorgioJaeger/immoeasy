...
<?php else: ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <!--        <img src="../server/php/files/' . $post['Post']['Livingrentsite']['id'] .'/'. $post['File'][0]['name']">-->
            <?php echo $this->Html->image('../server/php/files/' . $post['Post']['id'] .'/'. $post['File'][0]['name'], array('style' => 'width:100%')); ?>
        </div>
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <?php if (empty($post['Livingrentsite']['minDivisible'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Teilbar ab</strong>
                            <span class="pull-right">
  <?php echo($post['Livingrentsite']['minDivisible']); ?>
                            </span>
        ...
        <?php endif; ?>
            ...
            <?php if (empty($post['Livingrentsite']['recommendedUseTypes'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Empfohlene Nutzungsarten</strong>
                            <span class="pull-right">
  <?php echo($post['Livingrentsite']['recommendedUseTypes']); ?>
                            </span>
                </li>
            <?php endif; ?>

            <?php if (empty($post['Livingrentsite']['tenancy'] )): ?>
            <?php else: ?>
                <li class="list-group-item">
                    <strong>Heimfall nach ... Jahren (Pachtdauer)</strong>
                            <span class="pull-right">
  <?php echo($post['Livingrentsite']['tenancy']); ?>
                            </span>
                </li>
            <?php endif; ?>
            ...
            <?php if (empty($post['Livingrentsite']['siteDevelopmentType'] )): ?>

        <?php else: ?>
            <li class="list-group-item">
                <strong>Erschliessungs- zustand</strong>
                            <span class="pull-right">
  <?php echo($post['Livingrentsite']['siteDevelopmentType']); ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Livingrentsite']['siteConstructibleType'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Bebaubar nach</strong>
                            <span class="pull-right">
  <?php echo($post['Livingrentsite']['siteConstructibleType']); ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Livingrentsite']['grz'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>GRZ</strong>
                            <span class="pull-right">
  <?php echo($post['Livingrentsite']['grz']); ?>
                            </span>
            </li>
        <?php endif; ?>
            ...
            <?php if (empty($post['Livingrentsite']['gfz'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>GFZ</strong>
                            <span class="pull-right">
  <?php echo($post['Livingrentsite']['gfz']); ?>
                            </span>
            </li>
        <?php endif; ?>
...
<div class="row">
    ...
    <div class="col-md-9">
            ...
            <?php if (empty($post['Livingrentsite']['buildingPermission'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Livingrentsite']['demolition'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Livingrentsite']['shortTermConstructible'] )): ?>
                <li class="list-group-item">
...
<div class="col-sm-5  col-md-4 ">
    ...
    <?= $this->element('sidebar'); ?>
        ...
        <?php else: ?>
            <address>
                <legend>Objektadresse</legend>
                <!--                <strong>--><?php //echo $post['Post']['Livingrentsite']['street']; ?><!-- --><?php //echo $post['Post']['Livingrentsite']['houseNumber']; ?><!--</strong><br>-->
                <?php echo $post['Post']['postcode']; ?> <?php echo $post['Post']['city']; ?><br>
            </address>
