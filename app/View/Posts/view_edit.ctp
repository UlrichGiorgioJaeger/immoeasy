...
?>
<!--TODO google Maps richtig anzeigen set marker get Email an den Anbieter-->
<!DOCTYPE html>
<html>
<head>
    ...
    echo $this->Html->css('blueimp-gallery');
    echo $this->Html->css('blueimp-gallery-indicator');
    echo $this->Html->css('blueimp-gallery-video');
...
<ul class="nav nav-pills center-block">
    ...
    <li class="active"><a href="#">Vorschau</a></li>
...
<!--<div id="blueimp-gallery" class="blueimp-gallery" data-gallery>-->
...
<!--    <ol class="indicator"></ol>-->
    ...
    <!--    </div>-->
<!--</div>-->
<!--<div id="blueimp-image-carousel" class="blueimp-gallery blueimp-gallery-carousel" data-gallery>-->
<!--    <div class="slides"></div>-->
<!--    <h3 class="title"></h3>-->
<!--    <a class="prev">‹</a>-->
<!--    <a class="next">›</a>-->
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active" data-gallery>
<!--            <div id="links" class="links">-->

            <?php
//            echo $this->Html->image("carousel_2.jpg", array(
//                "alt" => "Brownies",
//                'url' => array('controller' => 'recipes', 'data-gallery' => 'data-gallery')
//            ));
...
<div class="row">
    <div class="col-md-3">
        <span class="glyphicon glyphicon-euro"> <?php echo h($post['Post']['price']); ?></span>
    ...
    <div class="col-md-9">
        ...
        <div class="col-md-3">
            <span class="glyphicon glyphicon-home">            <?php echo h($post['Post']['usableFloorSpace'])."m² "; ?>
</span>
        </div>
        <div class="col-md-3">
            <span class="glyphicon glyphicon-home">            <?php echo h($post['Post']['numberOfRooms']); ?>
                Zimmer</span>
        </div>
        <div class="col-md-3">
...
<div class="row">
    <div class="col-md-3">
        <span class="glyphicon glyphicon-euro"> Ausstattung</span>
        <span class="text-muted">500</span>
    </div>
                ...
                <li class="list-group-item">
                    <strong>Wohnfläche</strong>
                            <span class="pull-right">
                                <?php echo($post['Post']['livingSpace']); ?>
                            </span>
                </li>
            <?php endif; ?>
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="col-md-10">
                <span><?php echo $post['Post']['descriptionNote']?></span>
        </div>
    </div>
</div>
        <?php endif; ?>
...
<?php else: ?>
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-10">
                <span><?php echo $post['Post']['locationNote']?></span>
            </div>
        </div>
    </div>
<?php endif; ?>
...
<?php else: ?>
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-10">
                <span><?php echo $post['Post']['furnishingNote']?></span>
            </div>
        </div>
    </div>
<?php endif; ?>
...
?>
<h2 class="sub-header">col-sm-offset-8Section title</h2>
...
echo $this->Html->script('blueimp-gallery');
echo $this->Html->script('blueimp-gallery-fullscreen');
echo $this->Html->script('blueimp-gallery-indicator');
echo $this->Html->script('blueimp-gallery-video');
echo $this->Html->script('blueimp-gallery-vimeo');
echo $this->Html->script('blueimp-gallery-youtube');
echo $this->Html->script('jquery.blueimp-gallery');
