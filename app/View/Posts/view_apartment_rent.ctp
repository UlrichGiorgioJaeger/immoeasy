...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-gallery >
    ...
    //            echo $this->Html->image('carousel_2.jpg',array(alt=>'Erstes Bild'));
            echo $this->Html->image('../server/php/files/' . $post['Post']['id'] .'/'. $post['File'][0]['name'], array('style' => 'width:100%')); ?>
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <?php if (empty($post['Apartmentrent']['apartmentType'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Wohnungskategorie</strong>
                            <span class="pull-right">
                                               <?php echo($post['Apartmentrent']['apartmentType']); ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Apartmentrent']['serviceCharge'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Nebenkosten</strong>
                          <span class="pull-right">
 <?php
 $valu = $post['Apartmentrent']['serviceCharge'];
 echo $this->Number->currency($valu, "EUR");  ?>
            </li>
        <?php endif; ?>

        <?php if (empty($post['Apartmentrent']['heatingCosts'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Heizkosten</strong>
                          <span class="pull-right">
 <?php
 $valu = $post['Apartmentrent']['heatingCosts'];
 echo $this->Number->currency($valu, "EUR");  ?>
        ...
        <?php if (empty($post['Apartmentrent']['totalRent'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Gesamt miete</strong>
                          <span class="pull-right">
 <?php
 $valu = $post['Apartmentrent']['totalRent'];
 echo $this->Number->currency($valu, "EUR");  ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Apartmentrent']['deposit'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Kaution</strong>
                          <span class="pull-right">
<?php
$valu = $post['Apartmentrent']['deposit'];
echo $this->Number->currency($valu, "EUR");  ?>
                            </span>
            </li>
        <?php endif; ?>
        ...
        <?php if (empty($post['Apartmentrent']['heatingcostsInServiceCharge'] )): ?>
        <?php else: ?>
            <li class="list-group-item">
                <strong>Heizkosten sind in Nebenkosten enthalten.</strong>
                          <span class="pull-right">
                            <span class="glyphicon glyphicon-ok"></span>
<!--                              --><?php //echo($post['Apartmentrent']['heatingcostsInServiceCharge']); ?>
                            </span>
            </li>
        <?php endif; ?>
...
<div class="col-md-9">
    ...
    <?php if (empty($post['Apartmentrent']['floor'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Etage</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['floor']); ?>
                            </span>

        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['parkingSpacePrice'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Stellplatz Miete</strong>
                          <span class="pull-right">
                            <span class="glyphicon glyphicon-euro"></span>
                              <?php echo($post['Apartmentrent']['parkingSpacePrice']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentrent']['numberOfParkingSpaces'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Parkflächenanzahl</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['numberOfParkingSpaces']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['parkingSpaceType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Parkplatz</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['parkingSpaceType']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentrent']['condition'] )): ?>

    <?php else: ?>
        <li class="list-group-item">
            <strong>Objektzustand</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['condition']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Apartmentrent']['lastRefurbishment'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Letzte Modernisierung</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['lastRefurbishment']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentrent']['interiorQuality'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Qualität der Ausstattung</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['interiorQuality']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentrent']['constructionYear'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Baujahr</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['constructionYear']); ?>
                            </span>
        </li>
    <?php endif; ?>
    ...
    <?php if (empty($post['Apartmentrent']['freeFrom'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Frei ab</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['freeFrom']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['heatingType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Heizungsart</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['heatingType']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentrent']['firingTypes'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Befeuerungsarten</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['firingTypes']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['BuildingEnergyRatingType'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieausweistyp</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['BuildingEnergyRatingType']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['thermalCharacteristic'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieverbrauchskennwert</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['thermalCharacteristic']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['energyConsumptionContainsWarmWater'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Energieverbrauch enthält Warmwasser</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['energyConsumptionContainsWarmWater']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['numberOfFloors'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Etagenzahl</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['numberOfFloors']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentrent']['usableFloorSpace'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Nutzfläche</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['usableFloorSpace']); ?>
                            </span>
        </li>
    <?php endif; ?>

    <?php if (empty($post['Apartmentrent']['numberOfBedRooms'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Anzahl Schlafzimmer</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['numberOfBedRooms']); ?>
                            </span>
        </li>
    <?php endif; ?>


    <?php if (empty($post['Apartmentrent']['numberOfBathRooms'] )): ?>
    <?php else: ?>
        <li class="list-group-item">
            <strong>Anzahl Badezimmer</strong>
                            <span class="pull-right">
  <?php echo($post['Apartmentrent']['numberOfBathRooms']); ?>
                            </span>
        </li>
    <?php endif; ?>
...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="col-md-6">
            ...
            <?php if (empty($post['Apartmentrent']['lift'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentrent']['cellar'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentrent']['handicappedAccessible'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentrent']['guestToilet'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Apartmentrent']['listed'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Apartmentrent']['summerResidencePractical'] )): ?>
                <li class="list-group-item">
            ...
            <?php endif; ?>
            <?php if (empty($post['Apartmentrent']['builtInKitchen'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentrent']['balcony'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentrent']['certificateOfEligibilityNeeded'] )): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentrent']['garden'])): ?>
                <li class="list-group-item">
            ...
            <?php if (empty($post['Apartmentrent']['petsAllowed'])): ?>
                <li class="list-group-item">
...
<div class="col-sm-5  col-md-4 ">
    ...
    <?= $this->element('sidebar'); ?>
        ...
        <?php else: ?>
            <address>
                <legend>Objektadresse</legend>
                <!--                <strong>--><?php //echo $post['Post']['Apartmentrent']['street']; ?><!-- --><?php //echo $post['Post']['Apartmentrent']['houseNumber']; ?><!--</strong><br>-->
                <?php echo $post['Post']['postcode']; ?> <?php echo $post['Post']['city']; ?><br>
            </address>
