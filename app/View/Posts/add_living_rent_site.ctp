...
<legend>Zusatzinformationen zu Ihrer Immobilie</legend>
    ...
    <?php echo $this->Form->input('Livingrentsite.minDivisible', array(
    ...
    ?>
    <?php echo $this->Form->input('Livingrentsite.freeFrom', array('label' => 'Frei Ab',
        'dateFormat' => 'DMY',
        'minYear' => date('Y') - 70,
        'maxYear' => date('Y') - 18)); ?>
<?php

echo $this->Form->input('Livingrentsite.recommendedUseTypes', array(
    'empty' => '(auswählen)',
...
echo $this->Form->input('Livingrentsite.tenancy', array(
...
echo $this->Form->input('Livingrentsite.siteDevelopmentType', array(
    'empty' => '(auswählen)',
...
echo $this->Form->input('Livingrentsite.siteConstructibleType', array(
    'empty' => '(auswählen)',
    'label' => 'Bebaubar nach',
...
echo $this->Form->input('Livingrentsite.grz', array(
    'label' => array(
        'text' => 'Grz'
    ),
    'placeholder' => 'GRZ'
));
echo $this->Form->input('Livingrentsite.gfz', array(
    'label' => array(
        'text' => 'Gfz'
    ),
    'placeholder' => 'GFZ'
...
echo $this->Form->input('Livingrentsite.buildingPermission', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Livingrentsite.demolition', array(
    'type' => 'checkbox',
...
echo $this->Form->input('Livingrentsite.shortTermConstructible', array(
    'type' => 'checkbox',
