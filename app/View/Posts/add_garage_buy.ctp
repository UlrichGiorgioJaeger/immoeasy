...
echo $this->Form->input('Garagebuy.garageType', array(
    'empty' => '(auswählen)',
    'label' => 'Garagentyp',
    'options' => array(
        'Garage' => 'Garage',
...
echo $this->Form->input('Garagebuy.usableFloorSpace', array(
    'label' => 'Nutzfläche',
...
echo $this->Form->input('Garagebuy.constructionYear', array(
    'label' => array(
        'text' => 'Baujahr'
    ),
    'placeholder' => 'Baujahr'
...
?>
    ...
    <?php echo $this->Form->input('Garagebuy.freeFrom', array('label' => 'Frei Ab',
        'dateFormat' => 'DMY',
        'minYear' => date('Y') - 0,
        'maxYear' => date('Y') - 30)); ?>

    <?php echo $this->Form->input('Garagebuy.freeUntil', array('label' => 'Frei bis',
        'dateFormat' => 'DMY',
        'minYear' => date('Y') - 0,
        'maxYear' => date('Y') - 30)); ?>
    ...
    echo $this->Form->input('Garagebuy.lengthGarage', array(
        'label' => 'Länge',
        'placeholder' => 'Länge'
    ));


    echo $this->Form->input('Garagebuy.widthGarage', array(
        'label' => array(
            'text' => 'Weite'
        )
    ));

    echo $this->Form->input('Garagebuy.heightGarage', array(
        'label' => array(
            'text' => 'Höhe'
        )
    ));

    echo $this->Form->input('Garagebuy.condition', array(
        'empty' => '(auswählen)',
        'label' => 'Objektzustand',
    ...
    echo $this->Form->input('Garagebuy.lastRefurbishment', array(
        'label' => array(
