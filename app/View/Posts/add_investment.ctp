...
<?php echo $this->Form->create('Post.Investment', array(
    'inputDefaults' => array(
        'div' => 'form-group',
        'label' => array(
...
//
//));
echo $this->Form->inputs("Investment",array(
...
<div class="col-md-6" >
    ...
    <?php echo $this->Form->input('Post.kontaktName', array(
        'label' => 'KontaktName',
        'placeholder' => 'KontaktName',
    )); ?>
    <?php echo $this->Form->input('Post.kontaktEmail', array(
        'label' => 'Kontakt-E-Mail',
    )); ?>

    <?php echo $this->Form->input('Post.kontaktTel', array(
        'label' => 'Kontakt-Telefon',
    )); ?>

    <?php echo $this->Form->input('Post.kontaktMobil', array(
