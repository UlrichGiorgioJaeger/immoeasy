...
class RangeableBehavior extends ModelBehavior {
    ...
    function setup(Model $Model, $settings = array()) {
        ...
        $this->settings[$Model->alias] = array_merge(array(
            'field_lat' => 'latitude',
            'field_lon' => 'longitude',
            'field_zip' => 'postcode', // only used if 'lookup_zip_from_conditions' == true
            'lookup_zip_from_conditions' => true, // lookup a zip from the conditions array, remove from conditions array
            'lookup_zip_model_name' => 'Post',
            'lookup_zip_field_zip' => 'postcode',
            'lookup_zip_field_lat' => 'latitude',
            'lookup_zip_field_lon' => 'longitude',
